...
#define radians( xDegrees ) (xDegrees/180)*M_PI
#define degrees( xRadians ) (xRadians*180*M_1_PI)
...
double TinyGPSPlus::distanceBetween(double lat1, double long1, double lat2, double long2)
{
  ...
  delta = delta*delta; //calculate square
  delta += (clat2 * sdlong) * (clat2 * sdlong); //calculate square
  delta = sqrt(delta);
...
void TinyGPSLocation::commit()
{
   ...
   lastCommitTime = pdTICKS_TO_MS(xTaskGetTickCount());
   valid = updated = true;
}
